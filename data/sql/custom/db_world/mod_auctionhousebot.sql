...
REPLACE into mod_auctionhousebot (auctionhouse, name, minitems, maxitems, percentgreytradegoods, percentwhitetradegoods,
                                  percentgreentradegoods, percentbluetradegoods, percentpurpletradegoods,
                                  percentorangetradegoods, percentyellowtradegoods, percentgreyitems, percentwhiteitems,
                                  percentgreenitems, percentblueitems, percentpurpleitems, percentorangeitems,
                                  percentyellowitems, minpricegrey, maxpricegrey, minpricewhite, maxpricewhite,
                                  minpricegreen, maxpricegreen, minpriceblue, maxpriceblue, minpricepurple,
                                  maxpricepurple, minpriceorange, maxpriceorange, minpriceyellow, maxpriceyellow,
                                  ...
                                  minbidpriceyellow, maxbidpriceyellow, maxstackgrey, maxstackwhite, maxstackgreen,
...
/* Custom Config */
REPLACE INTO mod_auctionhousebot (auctionhouse, name, minitems, maxitems, percentgreytradegoods, percentwhitetradegoods, percentgreentradegoods, percentbluetradegoods, percentpurpletradegoods, percentorangetradegoods, percentyellowtradegoods, percentgreyitems, percentwhiteitems, percentgreenitems, percentblueitems, percentpurpleitems, percentorangeitems, percentyellowitems, minpricegrey, maxpricegrey, minpricewhite, maxpricewhite, minpricegreen, maxpricegreen, minpriceblue, maxpriceblue, minpricepurple, maxpricepurple, minpriceorange, maxpriceorange, minpriceyellow, maxpriceyellow, minbidpricegrey, maxbidpricegrey, minbidpricewhite, maxbidpricewhite, minbidpricegreen, maxbidpricegreen, minbidpriceblue, maxbidpriceblue, minbidpricepurple, maxbidpricepurple, minbidpriceorange, maxbidpriceorange, minbidpriceyellow, maxbidpriceyellow, maxstackgrey, maxstackwhite, maxstackgreen, maxstackblue, maxstackpurple, maxstackorange, maxstackyellow, buyerpricegrey, buyerpricewhite, buyerpricegreen, buyerpriceblue, buyerpricepurple, buyerpriceorange, buyerpriceyellow, buyerbiddinginterval, buyerbidsperinterval)
    values (7, 'Neutral', 1000, 2500, 0, 27, 12, 10, 1, 0, 0, 0, 10, 30, 8, 2, 0, 0, 100, 150, 150, 250, 800, 1400, 1250, 1750, 2250, 4550, 3250, 5550, 5250, 6550, 70, 100, 70, 100, 80, 100, 75, 100, 80, 100, 80, 100, 80, 100, 0, 0, 3, 2, 1, 1, 1, 1, 3, 5, 12, 15, 20, 22, 1, 1);
